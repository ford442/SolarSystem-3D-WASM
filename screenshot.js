...
const OUT = process.argv[3] || '/content/SolarSystem-3D-WASM/headless_chrome/screenshot.png';
...
async function run() {
  ...
  // Wait for WASM to initialize and textures to attempt loading.
  console.log('Waiting 20s for scene initialization and texture fetches...');
